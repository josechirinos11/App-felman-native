...
export default function Ubicaciones() {
  ...
  const [form, setForm] = useState<Record<string, string>>({
    nombre: '', descripcion: '', actualizado_por: ''
  });
  ...
  useEffect(() => {
    fetch(`${API_BASE}/control-almacen/ubicaciones`)
      .then(res => res.json())
      .then(json => json.status === 'ok' && setData(json.data))
      .catch(err => console.error('Fetch ubicaciones error:', err))
  ...
  const handleSubmit = async () => {
    ...
    const url = isUpdate
      ? `${API_BASE}/control-almacen/ubicacionesactualizar/${currentItem.id}`
      : `${API_BASE}/control-almacen/ubicacionescrear`;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.itemCount}>
            ...
            <Text style={styles.statusText}>{filtered.length} ubicaciones</Text>
          </View>
        </View>
      ...
      <Modal visible={modalVisible} animationType="slide">
        <View style={styles.modalContainer}>
          <Text style={styles.modalHeader}>{currentItem?.id ? 'Actualizar Ubicación' : 'Agregar Ubicación'}</Text>
          <ScrollView>
