...
export default function Categorias() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/control-almacen/categorias`)
      .then(res => res.json())
      .then(json => json.status === 'ok' && setData(json.data))
      .catch(err => console.error('Fetch categorias error:', err))
  ...
  const handleSubmit = async () => {
    ...
    const url = isUpdate
      ? `${API_BASE}/control-almacen/categoriasactualizar/${currentItem.id}`
      : `${API_BASE}/control-almacen/categoriascrear`;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.itemCount}>
            ...
            <Text style={styles.statusText}>{filtered.length} categorías</Text>
          </View>
        </View>
      ...
      <Modal visible={modalVisible} animationType="slide">
        <View style={styles.modalContainer}>
          <Text style={styles.modalHeader}>{currentItem?.id ? 'Actualizar Categoría' : 'Agregar Categoría'}</Text>
          <ScrollView>
