...
// Local definition of DiseñoConfig to avoid a missing import path; replace with your shared type if available.
type DiseñoConfig = {
  vistaTipo: 'list' | 'grid' | 'table';
  filtros: { id: string; label: string; campo: string; valor: string }[];
  ...
  botonesAccion: {
    id: string;
    label: string;
    // Using string here to avoid depending on IconName; change to IconName if you import it.
    icono?: string;
...
export default function ModalDiseñador({
  visible,
  onClose,
  configInicial,
  columnasDisponibles,
