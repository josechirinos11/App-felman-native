...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', padding: 12, backgroundColor: COLORS?.surface || '#f3f4f6', justifyContent: 'center' },
  statusText: { marginHorizontal: 6, fontSize: 16, fontWeight: 'bold' },
  connected: { color: COLORS?.success || '#047857' },
  disconnected: { color: COLORS?.error || '#b45309' },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS?.surface || '#f3f4f6', margin: 8, paddingHorizontal: 12, borderRadius: 8, elevation: 2 },
  searchInput: {
    flex: 1,
    height: 40,
    marginLeft: 8,
  ...
  filterButtonActive: {
    backgroundColor: COLORS?.primary || '#2e78b7',
    borderColor: COLORS?.primary || '#2e78b7',
  },
  filterText: {
    fontSize: 12,
    fontWeight: '600',
