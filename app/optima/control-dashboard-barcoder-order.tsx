  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.filters}>
        ...
        <View style={[styles.inputGroup, { flex: 1.4 }]}><Text style={styles.label}>Buscar</Text><TextInput value={search} onChangeText={setSearch} placeholder="pedido, ref, cliente..." style={styles.input} /></View>
